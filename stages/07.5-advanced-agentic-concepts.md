...
本 stage 用**工作邊界**作為整理進階 agentic workflow 的主軸：agent 操作的對象屬於 stack 哪一層？跨層越界會出什麼問題？這不是把整章縮成一個模型、而是先給讀者一個定位座標、後面的 12 個概念才能放到同一張圖上比較。
...
下面 12 個概念用表格列出（# / 概念 / Stack 層 / 一句話定義 / 最佳讀物）：

| # | 概念 | Stack 層 | 一句話定義 | 最佳讀物 |
|---|---|---|---|---|
