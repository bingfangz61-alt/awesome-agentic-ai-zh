...
> [繁體中文](./A3-cli-production.md) | [简体中文](./A3-cli-production.zh-CN.md) | **English**
...
> 💡 **Looking for MCPs that connect to daily tools** (Notion / Obsidian / Excel / Postgres / Playwright / Slack / Linear / Figma…): see [`resources/mcp-skills-catalog.en.md`](../../resources/mcp-skills-catalog.en.md) — 57 entries grouped by category, each with stars / license / audience. The list below is for "writing your own MCP server / finding reference implementations".
