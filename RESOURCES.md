...
- [**teng-lin/notebooklm-py**](https://github.com/teng-lin/notebooklm-py) ★ 12k+ — 非官方 NotebookLM Python API + CLI，支援 Claude Code / Codex 等 agent 整合
...
- [**WenyuChiou/ai-research-skills**](https://github.com/WenyuChiou/ai-research-skills) ★ 47 — 14 個研究流程 skill，5-plugin marketplace
- [**WenyuChiou/research-hub**](https://github.com/WenyuChiou/research-hub) ★ 14 — Zotero + Obsidian + NotebookLM 整合 workspace
...
> 上面只是 highlight。**完整 48 個整合的分類目錄**（含資料庫、瀏覽器自動化、Figma、Excalidraw、Cloudflare、Stripe、學術寫作 / Multi-LLM delegation 等）在 [`resources/mcp-skills-catalog.md`](resources/mcp-skills-catalog.md)。
